...
export function NotificationBell({ onToggleNoti, hasUnread }) {
  return (
    <button className="relative bg-white border border-base-brown-200 p-3 rounded-full cursor-pointer hover:bg-base-brown-200 transition-colors duration-200" onClick={onToggleNoti}>
