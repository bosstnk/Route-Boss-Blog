export const blogPosts = [
  {
    ...
    description:
      "Dive into the curious world of cat behavior, exploring why cats knead, purr, and chase imaginary prey. This article helps pet owners decode their feline's actions and strengthen their bond.",
    author: "Thompson P.",
  ...
  },
  {
    ...
    description:
      "Cats have captivated human hearts for thousands of years. Whether lounging in a sunny spot or playfully chasing a string, these furry companions bring warmth and joy to our lives.",
    author: "Thompson P.",
    date: "11 September 2024",
  },
  {
  ...
  },
  {
    ...
    description:
      "Discover the fascinating science behind the cat's purr, including its potential healing properties for both cats and humans. Learn how this unique sound is produced and its various functions in feline communication and well-being.",
    author: "Thompson P.",
    date: "11 September 2024",
  },
  {
  ...
  },
  {
    ...
    description:
      "This guide offers essential tips on keeping your cat in peak health. Covering topics like proper nutrition, regular vet visits, grooming, and mental stimulation, it's a must-read for any cat owner looking to ensure their feline friend lives a long, happy life.",
    author: "Thompson P.",
    date: "11 September 2024",
  },
];